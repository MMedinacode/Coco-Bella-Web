...
const MENU = {
  "helados": {
    ...
    "items": [
      {
        "n": "Copa de helado con toppings",
        "d": "Dos sabores con crema, salsa de chocolate, gomitas y barquillos — fotografiada en el local",
        "img": "copa-cocobella.jpg"
      },
      {
        "n": "Copa con crema y galletas",
        "d": "Con galletas de chocolate y barquillos — fotografiada en el local",
        "img": "copa-galletas.jpg"
      },
      {
        "n": "Helado en vasito",
        "d": "Con barquillo encima — fotografiado en el local",
        "img": "helado-vasito.jpg"
      },
      {
        "n": "Helado",
  ...
  "batidos": {
    "label": "Batidos y granizados",
    "items": [
      {
        "n": "Granizado",
        "d": "Fotografiado junto a su propia máquina de granizados",
        "img": "granizados.jpg"
      },
      {
        "n": "Batido con chocolate y crema",
        "d": "En vaso grande con tapa — fotografiado en el local",
        "img": "batido.jpg"
      }
    ]
  },
  "cafeteria": {
    ...
    "items": [
      {
        "n": "Café",
        "d": "Su propio logo lo dice: \"Coco Bella · Heladería & Cafetería\""
      }
    ]
  }
};
...
/* ---------- INDICADOR ABIERTO / CERRADO ----------
   ⚠️ Google confirma que CIERRA a las 20:00. La hora de apertura NO está publicada: se asume 12:00 como estimación y así se declara en Visítanos. */
